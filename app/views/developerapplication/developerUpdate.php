...
<form class="form-group" action="<?= URLROOT; ?>DevelopersApplicationController/updateDeveloper/<?= $data['developerId'] . "+" . $data['companyId']?>" method="post">
    <table>
        <tbody>
        <tr>
            <td>
...
<a class="btn btn-primary" href="<?= URLROOT; ?>DevelopersApplicationController/developerApplicationOverview/<?=$data['companyId']?>">Go back</a>
